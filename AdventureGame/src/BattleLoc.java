	...
	public boolean getLocation() {
		...
		if (selCase.equals("S")) {
			...
			if(player.getHealth() <= 0) {
				System.out.println("Öldünüz! yeni karakter yapın :)");
				return false;
			}
			...
			while (player.getHealth() > 0 && obstacle.getHealth() > 0) 
			{
				...
				if (selCase.equals("V")) {
					...
					if (obstacle.getHealth() > 0) 
					{
						...
						player.setHealth(player.getHealth() - ((obstacle.getDamage()*nobsCount) - player.getInv().getArmor()));
						afterHit();
					}
				...
				{
					System.out.println("Kaçarken arkanızdan vuruyorlar!!!");
					player.setHealth(player.getHealth() - ((obstacle.getDamage()*nobsCount) - player.getInv().getArmor()));
					afterHit();
					return false;
				}
